...
const Sports = () => {
    ...
    const fetch = async () => {
        try {
            const res = await axios.get("https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=b872e7db7cdb4e9693ed135e7350c758");
                ...
                {Data.map((value) => (
                            ...
                            <div className='sports-section'>
                                ...
                                <div className='flex justify-center mb-3'>
                                    ...
                                    <img className='h-[300px] shadow-xl hover:shadow-slate-500 rounded-md' src={value.urlToImage} alt={sports}></img>
